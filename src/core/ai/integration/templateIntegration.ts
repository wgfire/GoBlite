...
export class TemplateIntegration {
   ...
   * @returns 生成的提示词
   */
  public static generatePromptFromTemplate(
    template: Template,
    formData: Record<string, any>,
    generationType: AIGenerationType = AIGenerationType.CODE
  ): string {
    // 基础提示词
   ...
   * @returns 处理后的代码
   */
  public static processTemplateSpecificCode(
    template: Template,
    formData: Record<string, any>,
   ...
   * @returns 处理后的代码
   */
  private static processLandingPageCode(
    formData: Record<string, any>,
    generatedCode: string
  ): string {
   ...
   * @returns 处理后的代码
   */
  private static processBlogCode(
    formData: Record<string, any>,
    generatedCode: string
  ): string {
    let processedCode = generatedCode;
   ...
   * @returns 图像提示词
   */
  public static generateImagePrompt(
    template: Template,
    formData: Record<string, any>
  ): string {
    // 基础图像提示词
