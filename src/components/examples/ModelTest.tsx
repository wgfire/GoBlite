...
const ModelTest: React.FC = () => {
  ...
  const { initialize, sendMessage, currentModelType, switchModel } = useLangChainService({
  ...
  return (
    <div className="p-4 max-w-3xl mx-auto">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded ${
              currentModelType === AIModelType.DEEPSEEK
          ...
          <button
            ...
            className={`px-4 py-2 rounded ${
              currentModelType === AIModelType.GEMINI_PRO
                ? 'bg-blue-500 text-white'
                : 'bg-gray-200'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded ${
              currentModelType === AIModelType.GPT4O
                ? 'bg-blue-500 text-white'
                : 'bg-gray-200'
            }`}
          >
      ...
      <div className="mb-4">
        ...
        <div className="p-4 border rounded min-h-[200px] whitespace-pre-wrap">
          {response || '响应将显示在这里'}
        </div>
      </div>
    </div>
